  ...
  difficulty: {
    waves: [
      ...
      },
      {
        ...
        maxEnemies: 18,
        spawnBudget: 3,
        enemyWeights: { chaser: 0.55, brute: 1.2 },
      },
      {
        start: 90,
        spawnInterval: 1.35,
        ...
        maxEnemies: 22,
        spawnBudget: 3,
        enemyWeights: { chaser: 0.65, brute: 0.85 },
      },
      {
        start: 120,
        spawnInterval: 1.25,
    ...
    threat: {
      ...
      enemyScoreGrowth: 1.06,
      rangedProjectileSpeedGrowth: 1.03,
      rangedAttackSpeedGrowth: 1.035,
      healDropDecay: 0.97,
    },
    encounterTiming: {
      minStart: 900,
