...
import { createEmptyBossShadowReport } from "../src/application/BossEncounterShadowMonitor";
import { createEmptyChoiceInteractionReport } from "../src/application/ChoiceInteractionMonitor";
import {
  EX_PROTOCOL_CATALOG,
