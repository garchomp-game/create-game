---
title: "Legacy: Phaser Phase 5 Agent Task Briefs"
description: "Migrated from docs/18-phaser-phase5-agent-task-briefs.md."
---

> Source: `docs/18-phaser-phase5-agent-task-briefs.md`
