---
title: "Legacy: Phaser版 Phase 3 サブエージェント作業票"
description: "Migrated from docs/16-phaser-phase3-agent-task-briefs.md."
---

> Source: `docs/16-phaser-phase3-agent-task-briefs.md`
