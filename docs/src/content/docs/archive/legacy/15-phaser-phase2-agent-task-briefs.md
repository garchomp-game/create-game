---
title: "Legacy: Phaser版 Phase 2 サブエージェント作業票"
description: "Migrated from docs/15-phaser-phase2-agent-task-briefs.md."
---

> Source: `docs/15-phaser-phase2-agent-task-briefs.md`
