---
title: "Legacy: Arena Core 比較実験ドキュメント"
description: "Migrated from docs/README.md."
---
...
| `28-session-restart-guide.md` | 新しいセッションでゲーム開発へ戻るための入口、現在地、次アクション |
| `29-phaser-v03-pm-execution-plan.md` | Phaser v0.3のPM実行計画、サブエージェント分担、gate判断 |
| `30-phaser-v03-playtest-report.md` | Phaser v0.3 healing pickupの手動プレイ記録、KPI比較、調整仮説 |
| `31-phaser-v03-item-system-requirements.md` | PH-V03-004 item systemの最小data model、haste判断、test strategy |
| `32-phaser-controls-and-active-skill-discovery.md` | Phaser版の操作負荷、Space/right-click/number skill候補、active skill発見メモ |
| `33-phaser-v03-offscreen-enemy-indicator.md` | PH-V03-011 画面外敵方向indicatorの設計、実装結果、playtest観点 |
| `34-phaser-v03-summary-and-handoff.md` | Phaser v0.3の実装まとめ、検証baseline、次フェーズへのhandoff |
| `35-phaser-v03-stabilization-candidate.md` | PH-V03-010 v0.3 candidate判定、検証結果、残リスク分類 |
| `36-phaser-long-term-replayability-requirements.md` | Phaser v0.5以降のやりこみ、ステージ、装備、ランダム性の要件整理 |
