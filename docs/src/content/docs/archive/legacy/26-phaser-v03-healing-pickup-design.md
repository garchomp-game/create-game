---
title: "Legacy: PH-V03-001 Healing Pickup Foundation"
description: "Migrated from docs/26-phaser-v03-healing-pickup-design.md."
---

> Source: `docs/26-phaser-v03-healing-pickup-design.md`
...
- `kiteCollect` survival p50: 119.3s
- `kiteCollect` hpRecovered p50: 88
- `kiteCollect` healPickupsCollected p50: 22
- `kiteCollect` effectiveHealPickupsCollected p50: 8
- 2026-06-29のpulse split spread調整後も、balanceProbe violationsは `[]`。
