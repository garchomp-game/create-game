...
RC5の自動ゲートとpreview更新、`PH-V08-011`の表示境界、`PH-V08-012`の比較草案と採否、`PH-V08-013`の選択画面縦切りは完了しました。次はRC5の人間プレイ採否と並行して、`PH-V08-010`で世界観・素材を絞ります。その後、端末内進行と第1から第4ステージへA/B/Cの役割を展開します。
