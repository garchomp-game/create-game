...
| 4 | PR #91 | 圧力カーブ、計装、保守性、#83の設計判断、#97 / #98レーンをmainへ同期済み | 完了 |
...
| T1 | [#97](https://github.com/garchomp-game/create-game/issues/97) | 現行visualのTrainingで説明不足を切り分ける | 最新main統合済みruntime候補`78b79da9c5aa`、ローカルQA、PR CIを固定済み。owner再確認と新Preview待ち | 2ゲート後、#81で事前教材なしの総合演習とEndless 30秒probeをraw countで判断 |
...
3. **進行中**: #97の最新main統合済みTraining runtime候補`78b79da9c5aa`、ローカル自動証拠、PR CIを固定した。owner再確認と新immutable Previewの後に#81の初心者T1へ進む。
