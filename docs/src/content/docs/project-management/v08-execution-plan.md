...
| T1 | [#97](https://github.com/garchomp-game/create-game/issues/97) | 現行visualのTrainingで説明不足を切り分ける | 9課題runtime `78b79da9c5aa`、owner gate、PR CI、固定Previewが完了 | 実装はmain採用。#81で事前教材なしの総合演習とEndless 30秒probeをraw countで判断 |
