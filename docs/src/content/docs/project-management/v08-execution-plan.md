...
| T1 | [#97](https://github.com/garchomp-game/create-game/issues/97) | 現行visualのTrainingで説明不足を切り分ける | runtime候補`e87250500304`、owner gate、CI、immutable Previewを固定済み | #81で事前教材なしの総合演習とEndless 30秒probeをraw countで判断 |
