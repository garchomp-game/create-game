...
:::caution[履歴計画]
本ページの単独candidate列は2026-07-27のIssue整理前の履歴です。
現在の単一Nextと実行順は[課題解決キュー](../issue-resolution-queue/)を
正本とします。閉じた#76 / #77 / #79 / #93を再開条件として使いません。
:::

:::note[現在の統合レーン]
main `60ae8889390c`までに観測、選択UI、9課題Training、desktop gate、
WebGL fallback、Phase A fixture、StudyLog契約を統合しました。
[#126](https://github.com/garchomp-game/create-game/issues/126)の
EX Protocol C2はこの基盤への再統合、固定Version Preview、全CIを完了しました。
通常buildとproductionはEX OFFのまま、人間6体系と実GPUの採否を待っています。
:::
...
| 8 | Issue #126 / Draft PR #127 | 最新main統合、固定Preview、4件のCIが完了 | 人間6体系、実GPU確認、明示的な採否 |
