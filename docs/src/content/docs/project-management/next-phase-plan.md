...
EX Protocol C2最新main統合です。C2は通常buildでOFF、production trafficは
v0.6.8のまま維持し、人間6体系確認前に採用しません。
:::
...
- EX C2 integration: Issue [#126](https://github.com/garchomp-game/create-game/issues/126) / branch `agent/v08-ex-c2-integration`
