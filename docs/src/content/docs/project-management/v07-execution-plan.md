...
状態: RC5の固定3 seed x 2武器は6勝、決定論replay、72件のE2E、production build、Version Preview smokeを通過しました。これはRC6の回帰基準です。#73から#75は完了し、Wave 4でExpedition難度時計をAct進行へ同期しました。RC6は全入力replay、398件のunit / simulation、72件のE2E、production build、Starlight buildを通過済みです。通常UI採否と新Previewのsmokeが終わるまでproductionへ昇格しません。
