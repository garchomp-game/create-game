...
状態: RC1 / RC2の自動QAとPulse手動2ランを調整根拠に、`0.7.0` / `phaser-v0.7.0-final-expedition-rc3`を実装中です。敵導入順、大型黄HP 8、Commander HP 500、追跡ボス、通常ウェーブ継続を追加し、両武器の到達性と全回帰を再検証しています。production昇格はRC3の各武器3本の人間プレイ待ちです。詳細は[v0.7 統合QAレポート](../../playtest/v07-qa-report/)を参照してください。
