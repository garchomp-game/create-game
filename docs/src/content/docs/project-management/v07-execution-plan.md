---
title: v0.7 実行計画
description: 公開ベータの基準固定から最終遠征RC3とEndless RC4の採否までの依存順とチケット詳細。
---
...
- Wave 2から5までを`agent/v07-first-expedition`へ独立コミットで統合し、指揮艦ボスと撃破勝利まで接続しました。RC2の手動所感を受け、現行ステージを第10最終遠征へ再分類しました。RC4でEndlessのC5到達性を改善しつつ、最終遠征RC3の戦闘値と自動probeを完全維持しています。
...
状態: RC1 / RC2の自動QAとPulse手動2ランを調整根拠に、RC3で敵導入順、大型黄HP 8、Commander HP 500、追跡ボス、通常ウェーブ継続を追加しました。RC4でEndlessのEX曲線だけを緩和し、固定6ランのC5以上を0 / 6から3 / 6へ改善しました。最終遠征は旧曲線をStage定義で保持し、RC3の6ランと同一結果を再現しています。`0.7.0` / `phaser-v0.7.0-final-expedition-rc4`の全回帰とVersion Preview公開は完了し、production昇格は各武器3本の人間プレイ待ちです。詳細は[v0.7 統合QAレポート](../../playtest/v07-qa-report/)を参照してください。
...
| 6 | `PH-V07-008` | RC4自動回帰、性能、preview、文書を完了。production昇格は手動採否待ち |
