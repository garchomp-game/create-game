...
状態: 自動QA完了、技術preview採用。`0.7.0` / `phaser-v0.7.0-first-expedition`へ版を分け、単体348件、Playwright 69件、画像30件、3 seed x 2武器の到達性probeを通過しました。production昇格とv0.8着手は各武器3本の人間プレイ待ちです。詳細は[v0.7 統合QAレポート](../../playtest/v07-qa-report/)を参照してください。
