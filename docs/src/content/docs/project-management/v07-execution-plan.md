...
状態: 2026-07-17完了後、手動所感をRC2へ反映。固定照準弾幕と安全な挟撃増援に加え、護衛ターンの抑制斉射、HP 50%の弾数・護衛数増加、道中圧力の退避、専用HP / 予告 / 音 / 撃破演出を接続しました。RC2の3 seed x 2武器は8:53から10:01で全勝利し、最大敵18、総弾37、Pickup 67でした。
...
状態: RC1の自動QA後、Pulse手動2ランを調整根拠にRC2を実装。`0.7.0` / `phaser-v0.7.0-first-expedition-rc2`の到達性probeは3 seed x 2武器で全勝利しました。production昇格とv0.8着手はRC2の全回帰と各武器3本の人間プレイ待ちです。詳細は[v0.7 統合QAレポート](../../playtest/v07-qa-report/)を参照してください。
