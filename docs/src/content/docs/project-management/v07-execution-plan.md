...
- Wave 2から5までを`agent/v07-first-expedition`へ独立コミットで統合し、最初の指揮艦ボスと撃破勝利まで接続しました。残りは`PH-V07-008`の総合QAとpreview採否です。
...
状態: 2026-07-17完了。固定照準弾幕と安全な挟撃増援、HP 50%の段階変化、専用HP / 予告 / 音 / 撃破演出、攻撃源別記録、撃破による一回だけの勝利確定を接続しました。固定seedの早送り確認ではPulse 9:03、Spread 9:50で完了し、最大敵35、総弾35、Pickup 109でした。
...
状態: 自動QA完了、技術preview採用。`0.7.0` / `phaser-v0.7.0-first-expedition`へ版を分け、単体348件、Playwright 70件、画像31件、3 seed x 2武器の到達性probeを通過しました。Commander、Charger、Bossは専用のブラウザfixtureでも固定しています。production昇格とv0.8着手は各武器3本の人間プレイ待ちです。詳細は[v0.7 統合QAレポート](../../playtest/v07-qa-report/)を参照してください。
