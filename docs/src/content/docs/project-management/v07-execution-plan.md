---
title: v0.7 実行計画
description: 公開ベータの基準固定から最終遠征RC3採否までの依存順とチケット詳細。
---
...
- Wave 2から5までを`agent/v07-first-expedition`へ独立コミットで統合し、指揮艦ボスと撃破勝利まで接続しました。RC2の手動所感を受け、現行ステージを第10最終遠征へ再分類したRC3の総合QAとpreview採否を進めています。
...
状態: RC1 / RC2の自動QAとPulse手動2ランを調整根拠に、`0.7.0` / `phaser-v0.7.0-final-expedition-rc3`を実装しました。敵導入順、大型黄HP 8、Commander HP 500、追跡ボス、通常ウェーブ継続を追加し、全回帰とVersion Preview公開まで完了しています。production昇格はRC3の各武器3本の人間プレイ待ちです。詳細は[v0.7 統合QAレポート](../../playtest/v07-qa-report/)を参照してください。
...
| 6 | `PH-V07-008` | 自動回帰、性能、preview、文書を完了。production昇格は手動採否待ち |
