...
| 状態 | Draft PR [#99](https://github.com/garchomp-game/create-game/pull/99)の3 CI jobはgreen。[#81](https://github.com/garchomp-game/create-game/issues/81)の人間T1待ち |
...
| GitHub Actions | Phaser quality、Starlight build、Browser release smokeの3 job pass |
