...
:::caution[採用判定ではない]
C2はownerのC1フィードバックを反映した比較候補です。2026-07-24に[#126](https://github.com/garchomp-game/create-game/issues/126)で最新mainへの再統合を開始しましたが、production trafficと既存C1 Previewは変更していません。20 seed、90秒soak、Final Expedition 40本、人間6体系確認は採用前ゲートとして残します。
:::

## 最新mainへの再統合

`origin/main`の`60ae8889390c`を基点に、採用済み選択UI、9課題Training、
desktop gate、WebGL fallback、StudyLog契約とC2を結合しました。
