...
レビュー依頼可能。ゲームルールbaselineはRC6 merge `0e07347424a8`、Expedition ruleset `phaser-v0.7.0-final-expedition-rc6`です。現在のmain HEADはCI追加後の`0ef2f4e50481`で、RC6以降にゲーム数値は変更していません。production trafficはv0.6.8を維持しています。選択画面の改善はDraft PR #84と別Previewで評価中です。
