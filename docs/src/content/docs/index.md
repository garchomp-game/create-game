...
| 外部助言と再レビュー論点 | [外部ゲームデザイン助言メモ](design/external-game-design-advice/) / [v0.8 Work再レビュー依頼](playtest/v08-work-design-review-request/) / [v0.8 面白さの核の検証](design/core-promise-validation/) / [危険反転の実装前比較](design/hazard-reversal-preflight/) |
