...
| --- | --- |
| 主実装 | Phaser版 |
| 現在の基盤 | productionはv0.6.8。v0.7 RC6の自動・手動採否は完了し、main統合待ち |
| 公開先 | [arena-core.garchomp-game.workers.dev](https://arena-core.garchomp-game.workers.dev/) |
| 次の作業 | RC6専用Draft PR #82の統合と、UI candidateの独立採否 |
| その次 | #83の設計レビュー、v0.8縦切り、配布SHA固定後のproduction昇格 |
...
| 外部助言と再レビュー論点 | [外部ゲームデザイン助言メモ](design/external-game-design-advice/) / [v0.8 面白さの核の検証](design/core-promise-validation/) |
