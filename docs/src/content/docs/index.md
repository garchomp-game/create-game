...
| 次の作業 | 固定済みTraining T1候補を使った#81の人間転移確認。並行してEX Protocol local candidateの全体回帰と未完了gateを整理 |
...
| 実際のプレイ結果と次回手順 | [手動プレイ記録](playtest/playtest-notes/) / [バランス回帰テスト](playtest/balance-probe/) / [RC6現行QA](playtest/v07-rc6-integration-report/) / [Training T1候補](playtest/v08-training-t1-candidate/) / [v0.8 構造化プレイテスト記録票](playtest/v08-structured-playtest-template/) |
