...
| --- | --- |
| 主実装 | Phaser版 |
| 現在の基盤 | productionはv0.6.8。v0.7 RC6のrelease contractと自動ゲートは完了 |
| 公開先 | [arena-core.garchomp-game.workers.dev](https://arena-core.garchomp-game.workers.dev/) |
| 次の作業 | RC6専用Draft PRと最終Version Previewを基点に、Pulse / Spread各1本以上の欠陥特化採否 |
| その次 | 採否通過後のproduction昇格とv0.8チャレンジ・熟練度設計 |
