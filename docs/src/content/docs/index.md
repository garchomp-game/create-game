...
| 次の作業 | UI Draft PR #84の外部採否と、#83のWork設計レビュー |
| その次 | v0.8の単独縦切り、配布SHA固定後のproduction昇格 |
...
| 外部助言と再レビュー論点 | [外部ゲームデザイン助言メモ](design/external-game-design-advice/) / [v0.8 Work再レビュー依頼](playtest/v08-work-design-review-request/) / [v0.8 面白さの核の検証](design/core-promise-validation/) / [危険反転の実装前比較](design/hazard-reversal-preflight/) / [武器教義の実装前比較](design/weapon-doctrine-preflight/) / [最大密度の可読性・警告音 事前監査](design/maximum-density-readability-preflight/) |
| 実装上の境界と品質基準 | [アーキテクチャ](engineering/architecture/) / [品質戦略](engineering/quality-strategy/) |
| UI、グラフィック、比較草案 | [UI・グラフィック再設計計画](project-management/ui-visual-redesign-plan/) / [UI/UXとフィードバック](design/ui-ux/) |
...
| 実際のプレイ結果と次回手順 | [手動プレイ記録](playtest/playtest-notes/) / [バランス回帰テスト](playtest/balance-probe/) / [RC6現行QA](playtest/v07-rc6-integration-report/) / [v0.8 構造化プレイテスト記録票](playtest/v08-structured-playtest-template/) |
