...
| --- | --- |
| 主実装 | Phaser版 |
| 現在の基盤 | productionはv0.6.8。v0.7最初のExpeditionは技術preview採用 |
| 公開先 | [arena-core.garchomp-game.workers.dev](https://arena-core.garchomp-game.workers.dev/) |
| 次の作業 | v0.7 Version PreviewでPulse / Spread各3本の手動採否 |
...
| 実際のプレイ結果 | [手動プレイ記録](playtest/playtest-notes/) / [バランス回帰テスト](playtest/balance-probe/) / [v0.7 統合QA](playtest/v07-qa-report/) |
