...
| 次の作業 | 同一control buildでEndless / 最終遠征を両武器各1本と、5分自由選択を観察する |
| その次 | 観測事実を基に、Charger、選択UI、Boss、イベント緩和のcandidateを1件ずつ比較する |
...
| 実際のプレイ結果と次回手順 | [手動プレイ記録](playtest/playtest-notes/) / [バランス回帰テスト](playtest/balance-probe/) / [RC6現行QA](playtest/v07-rc6-integration-report/) / [control観測build実施手順](playtest/v08-observation-control-runbook/) / [v0.8 構造化プレイテスト記録票](playtest/v08-structured-playtest-template/) |
