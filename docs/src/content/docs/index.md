...
| --- | --- |
| 主実装 | Phaser版 |
| 現在の基盤 | v0.5完了。ラン記録、履歴、ランキング、設定、画面、音響 |
| 次の実装対象 | v0.6のビルド個性、成長間隔、エンドレス後半 |
| その次 | v0.7の戦闘展開、ステージ、エリート、ボス試作 |
...
| バージョンごとの作業内容 | [ロードマップ](project-management/roadmap/) / [チケット一覧](project-management/tickets/) / [v0.5チケット詳細](project-management/v05-tickets/) |
