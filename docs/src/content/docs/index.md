...
| 実際のプレイ結果 | [手動プレイ記録](playtest/playtest-notes/) / [バランス回帰テスト](playtest/balance-probe/) / [v0.7 RC5基準QA](playtest/v07-qa-report/) / [RC6現行QA](playtest/v07-rc6-integration-report/) |
