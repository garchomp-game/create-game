...
1. v0.7 RC6のproduction採否を終える。
2. #66で世界観、視覚言語、素材境界を決める。
3. #76危険反転と#78選択テンポを独立して検証する。
4. #77技能ledgerで観測可能にする。
5. #79武器教義を最小branchで試す。
6. #80最大密度fixtureで視覚と音を固定する。
7. #81の初心者・経験者テストで採用、再調整、延期を決める。
8. 採用した核だけをStage 1 / 5 / 10へ展開する。
